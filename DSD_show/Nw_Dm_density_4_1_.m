...
ax1=subplot(2,2,1);
c1=colormap(jet(20));
sc1 = scatplot(Dm_stra_all,Nw_stra_all);
hold on
% xfit= 0.5:0.1:2.2;
% yfit = -1.57*xfit + 5.64;
...
text(0.1,5.7,'(a)','FontSize',12);

ax2=subplot(2,2,2);
sc2 = scatplot(Dm_conv_all,Nw_conv_all);
...
ax3.Position = [0.06 0.08 0.4 0.42];
ax3.Box = 'on';
ax3.FontSize = 12;
...
e1.CapSize = 5;
hold off
legend('Con.-spr.','Con.-sum.','Con.-aut.','Con.-win.');
ax4.Position = [0.495 0.08 0.4 0.42];
ax4.Box = 'on';
ax4.FontSize = 12;
